...
interactive plot such that the user selects the variable to be placed on the x and y axes from 
a drop down menu. You can place that drop down menu on the sidebar (like on the class example), 
or feel free to get creative with it...
